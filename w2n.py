# Vendored verbatim from word2number 1.1 (https://github.com/akshaynagpal/w2n)
#
# The MIT License (MIT) - Copyright (c) 2016 Akshay Nagpal
# Full license text: https://github.com/akshaynagpal/w2n/blob/master/LICENSE.txt
#
# Vendored because the upstream package ships no wheel, only an sdist whose
# setup.py passes the full license text to setuptools' `license=` field -
# a pattern newer setuptools rejects. Building it in the Streamlit Cloud
# image is an avoidable failure mode for ~200 lines of pure Python that the
# M3DocVQA answer-normalisation step depends on.
